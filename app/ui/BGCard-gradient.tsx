  ...
  return (
    <div className="w-full">
      <BackgroundGradient className="rounded-[22px] p-2  space-y-2 sm:p-10 lg:p-8 bg-black lg:w-full lg:space-y-14 ">
        <h3 className="lg:text-white lg:text-2xl lg:pl-80 hidden md:block">C'est quoi BPartners??</h3>
        ...
        <p className="text-sm text-white sm:text-justify md:text-lg lg:text-xl lg:text-left sm:text-justify xl:text-2xl xl:pt">B-Partners est un cabinet d’intermédiation pluridisciplinaire, spécialisé dans l’accompagnement professionnel des promoteurs, organisations et entreprises.
